...
<div class="card shadow mb-4 mt-5">
        ...
        <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
            <form action="/galeri/simpanedit/{{$show->id}}" method="post" enctype="multipart/form-data">
                @csrf                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                        <input type="file" name="foto_4" value="{{$show->foto_4}}" class="custom-file-input" id="customFile">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                        @error('foto_4')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                        <input type="file" name="foto_5" value="{{$show->foto_5}}" class="custom-file-input" id="customFile">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                        @error('foto_5')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                        <input type="file" name="foto_6" value="{{$show->foto_6}}" class="custom-file-input" id="customFile">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                        @error('foto_6')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                        <input type="file" name="foto_7" value="{{$show->foto_7}}" class="custom-file-input" id="customFile">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                        @error('foto_7')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                        <input type="file" name="foto_8" value="{{$show->foto_8}}" class="custom-file-input" id="customFile">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                        </div>
                        @error('foto_8')
                            <div class="text-danger">{{ $message }}</div>
